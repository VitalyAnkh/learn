                ...
                ListView::new()
                    ...
                    .child(
                        ...
                        Checkbox::new().on_change(|s, checked| {
                            ...
                            for name in &["email1", "email2"] {
                                s.call_on_id(name, |view: &mut EditView| view.set_enabled(checked));
                                if checked {
                    ...
                    .child(
                        ...
                        LinearLayout::horizontal()
                            .child(EditView::new().disabled().with_id("email1").fixed_width(15))
                            .child(TextView::new("@"))
                            .child(EditView::new().disabled().with_id("email2").fixed_width(10)),
                    )
