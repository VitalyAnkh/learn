...
/* package Play-0.1.0.0 */
#ifndef VERSION_Play
#define VERSION_Play "0.1.0.0"
#endif /* VERSION_Play */
#ifndef MIN_VERSION_Play
#define MIN_VERSION_Play(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Play */
...
#define CURRENT_COMPONENT_ID "Play-0.1.0.0-inplace-Play"
