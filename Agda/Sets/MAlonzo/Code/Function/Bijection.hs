...
data T18
  = C81 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
data T64 = C473 MAlonzo.Code.Function.Equality.T16 T18
...
d92 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T64 -> AgdaAny -> AgdaAny
...
du98 v0
  = coe
      (MAlonzo.Code.Function.Injection.C429
         (coe (d82 (coe v0))) (coe (d38 (coe (d84 (coe v0))))))
...
du100 v0
  = coe
      (MAlonzo.Code.Function.Surjection.C217
         (coe (d82 (coe v0))) (coe (d40 (coe (d84 (coe v0))))))
...
du104 v0
  = coe
      (MAlonzo.Code.Function.Surjection.du92 (coe (du100 (coe v0))))
...
du108 v0
  = coe
      (MAlonzo.Code.Function.Surjection.du82 (coe (du100 (coe v0))))
...
du114 v0 v1 v2
  = coe
      (MAlonzo.Code.Function.LeftInverse.du192
         (coe v0) (coe v1) (coe (du110 (coe v2))))
...
d160 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 -> T64
d160 v0 v1 v2 = du160 v2
du160 :: MAlonzo.Code.Relation.Binary.T128 -> T64
du160 v0
  = coe
      (C473
...
d182 ::
  ...
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T64 -> T64 -> T64
d182 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 = du182 v8 v9 v10
du182 :: MAlonzo.Code.Relation.Binary.T128 -> T64 -> T64 -> T64
du182 v0 v1 v2
  = coe
      (C473
         (coe
            (MAlonzo.Code.Function.Equality.du82
               (coe (d82 (coe v1))) (coe (d82 (coe v2)))))
         (coe
            (C81
               (coe
                  (\ v3 v4 v5 ->
                  ...
                  (MAlonzo.Code.Function.Surjection.d74
                     (coe
                        (MAlonzo.Code.Function.Surjection.du196
                           (coe v0) (coe (du100 (coe v1))) (coe (du100 (coe v2))))))))))
