...
data T88
  = C429 MAlonzo.Code.Function.Equality.T16
...
d152 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 -> T88
d152 v0 v1 v2 = du152
du152 :: T88
du152
  = coe
...
d172 ::
  ...
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T88 -> T88 -> T88
      ...
      (C429
         (coe
            (MAlonzo.Code.Function.Equality.du82
               (coe (d106 (coe v0))) (coe (d106 (coe v1)))))
         (coe
            (\ v2 v3 v4 ->
               coe
                 d108 v1 v2 v3
