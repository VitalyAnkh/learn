...
data T18
  = C65 MAlonzo.Code.Function.Equality.T16 (AgdaAny -> AgdaAny)
...
data T54 = C217 MAlonzo.Code.Function.Equality.T16 T18
...
du88 v0 v1 v2 v3
  = coe
      (MAlonzo.Code.Function.LeftInverse.du176
         (coe v0) (coe (du82 (coe v1))) (coe v2) (coe v3))
...
du92 v0
  = coe
      (MAlonzo.Code.Function.Equivalence.C1
         (coe (d72 (coe v0))) (coe (d38 (coe (d74 (coe v0))))))
...
d168 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 -> T54
d168 v0 v1 v2 = du168 v2
du168 :: MAlonzo.Code.Relation.Binary.T128 -> T54
du168 v0
  = coe
      (C217
         ...
         (coe
            (C65
               (coe
                  (MAlonzo.Code.Function.LeftInverse.d102 (coe (du176 (coe v0)))))
               (coe
                  (MAlonzo.Code.Function.LeftInverse.d106 (coe (du176 (coe v0))))))))
...
du176 ::
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Function.LeftInverse.T82
du176 v0 = coe (MAlonzo.Code.Function.LeftInverse.du256 (coe v0))
...
d196 ::
  ...
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T54 -> T54 -> T54
d196 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 = du196 v8 v9 v10
du196 :: MAlonzo.Code.Relation.Binary.T128 -> T54 -> T54 -> T54
du196 v0 v1 v2
  = coe
      (C217
         (coe
            (MAlonzo.Code.Function.Equality.du82
               (coe (d72 (coe v1))) (coe (d72 (coe v2)))))
         (coe
            (C65
               (coe
...
du206 v0 v1 v2
  = coe
      (MAlonzo.Code.Function.LeftInverse.du280
         (coe v0) (coe (du82 (coe v2))) (coe (du82 (coe v1))))
