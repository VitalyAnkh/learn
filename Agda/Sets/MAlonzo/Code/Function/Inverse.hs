...
data T20 = C125 (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
...
du90 v0
  = coe
      (MAlonzo.Code.Function.LeftInverse.C521
         (coe (d78 (coe v0))) (coe (d80 (coe v0)))
         (coe (d42 (coe (d82 (coe v0))))))
...
du94 v0 v1
  = coe
      (MAlonzo.Code.Function.LeftInverse.du184
         (coe v0) (coe (du90 (coe v1))))
...
du96 v0 v1
  = coe
      (MAlonzo.Code.Function.LeftInverse.du176
         (coe v0) (coe (du90 (coe v1))))
...
du98 v0 v1
  = coe
      (MAlonzo.Code.Function.Bijection.C473
         (coe (d78 (coe v1)))
         (coe
            (MAlonzo.Code.Function.Bijection.C81
               (coe
                  (MAlonzo.Code.Function.LeftInverse.du176
                     (coe v0) (coe (du90 (coe v1)))))
               (coe
                  (MAlonzo.Code.Function.Surjection.C65
                     (coe (d80 (coe v1))) (coe (d44 (coe (d82 (coe v1))))))))))
...
du104 ::
  ...
  T58 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du104 v0 v1 v2
  = let v3 = du98 (coe v0) (coe v2) in
    let v4 = MAlonzo.Code.Function.Bijection.du100 (coe v3) in
    coe
      (MAlonzo.Code.Function.LeftInverse.du192
         (coe v1) (coe v0)
...
d186 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 -> T58
d186 v0 v1 v2 = du186 v2
du186 :: MAlonzo.Code.Relation.Binary.T128 -> T58
du186 v0
  = coe
      (C309
         ...
         (coe
            (C125
               (coe
                  (MAlonzo.Code.Function.LeftInverse.d106 (coe (du194 (coe v0)))))
               (coe
                  (MAlonzo.Code.Function.LeftInverse.d106 (coe (du194 (coe v0))))))))
...
du194 ::
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Function.LeftInverse.T82
du194 v0 = coe (MAlonzo.Code.Function.LeftInverse.du256 (coe v0))
...
d208 ::
  ...
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T58 -> T58 -> T58
      ...
      (C309
         (coe
            (MAlonzo.Code.Function.Equality.du82
               (coe (d78 (coe v2))) (coe (d78 (coe v3)))))
         (coe
            (MAlonzo.Code.Function.Equality.du82
               (coe (d80 (coe v3))) (coe (d80 (coe v2)))))
         (coe
            (C125
               (coe
                  (\ v4 ->
                             ...
                             (coe
                                (MAlonzo.Code.Relation.Binary.Reasoning.Base.Single.du50
                                   ...
                                   (coe
                                      MAlonzo.Code.Function.Equality.d38 (d80 (coe v3))
                                      (coe MAlonzo.Code.Function.Equality.d38 (d78 (coe v3)) v4))
                                   (coe v4) (coe v4) (coe d42 (d82 (coe v3)) v4)
                                   (let v5
                             ...
                             (coe
                                (MAlonzo.Code.Relation.Binary.Reasoning.Base.Single.du50
                                   ...
                                   (coe
                                      MAlonzo.Code.Function.Equality.d38 (d78 (coe v2))
                                      (coe MAlonzo.Code.Function.Equality.d38 (d80 (coe v2)) v4))
                                   (coe v4) (coe v4) (coe d44 (d82 (coe v2)) v4)
                                   (let v5
                                          = MAlonzo.Code.Relation.Binary.Core.d414
...
d226 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Relation.Binary.T128 ->
  MAlonzo.Code.Relation.Binary.T128 -> T58 -> T58
d226 v0 v1 v2 v3 v4 v5 v6 = du226 v6
du226 :: T58 -> T58
du226 v0
  = coe
      (C309
         (coe (d80 (coe v0))) (coe (d78 (coe v0)))
         (coe
            (C125
               (coe (d44 (coe (d82 (coe v0)))))
               (coe (d42 (coe (d82 (coe v0))))))))
...
du298 v0 v1 v2 v3
  = coe
      (C309
         (coe v0 (d78 (coe v3))) (coe v1 (d80 (coe v3)))
