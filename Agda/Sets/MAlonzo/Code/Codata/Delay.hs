             ...
             (MAlonzo.Code.Codata.Conat.C12
                (coe
                   (MAlonzo.Code.Codata.Thunk.C3
                      (coe
                         (\ v2 -> du32 (coe MAlonzo.Code.Codata.Thunk.d24 v1 erased))))))
...
du40
  = coe
      (C20 (coe (MAlonzo.Code.Codata.Thunk.C3 (coe (\ v0 -> du40)))))
...
du46 v0 v1
  = case coe v0 of
      0 -> coe MAlonzo.Code.Data.Maybe.Base.C30
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             C18 v3 -> coe (MAlonzo.Code.Data.Maybe.Base.C28 (coe v3))
             C20 v3
               -> coe
                    (du46 (coe v2) (coe MAlonzo.Code.Codata.Thunk.d24 v3 erased))
             _ -> MAlonzo.RTE.mazUnreachableError
             ...
             (C20
                (coe
                   (MAlonzo.Code.Codata.Thunk.C3
                      (coe
                         (\ v3 ->
                            du72 (coe v0) (coe MAlonzo.Code.Codata.Thunk.d24 v2 erased))))))
      _ -> MAlonzo.RTE.mazUnreachableError
             ...
             (C20
                (coe
                   (MAlonzo.Code.Codata.Thunk.C3
                      (coe
                         (\ v3 ->
                            du86 (coe MAlonzo.Code.Codata.Thunk.d24 v2 erased) (coe v1))))))
      _ -> MAlonzo.RTE.mazUnreachableError
                       ...
                       (coe
                          (MAlonzo.Code.Codata.Thunk.C3
                             (coe
                                (\ v5 ->
                                   du142
                                     (coe v0) (coe MAlonzo.Code.Codata.Thunk.d24 v3 erased)
  ...
  = case coe v1 of
      C18 v3
        -> case coe v2 of
             C18 v4
               -> coe
                    (C18 (coe v0 (MAlonzo.Code.Data.These.Base.C52 (coe v3) (coe v4))))
             C20 v4
               -> coe (C18 (coe v0 (MAlonzo.Code.Data.These.Base.C48 (coe v3))))
             _ -> MAlonzo.RTE.mazUnreachableError
      C20 v3
        -> case coe v2 of
             C18 v4
               -> coe (C18 (coe v0 (MAlonzo.Code.Data.These.Base.C50 (coe v4))))
             C20 v4
               -> coe
                    (C20
                       (coe
  ...
  = case coe v1 of
      ...
      C228 v3
        -> case coe v0 of
             C20 v4
               -> coe
                    (du232 (coe MAlonzo.Code.Codata.Thunk.d24 v4 erased) (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      C228 v3
        -> case coe v0 of
             C20 v4
               -> coe
                    (\ v5 v6 -> MAlonzo.Code.Codata.Conat.C126 v6) erased
                    (du244 (coe MAlonzo.Code.Codata.Thunk.d24 v4 erased) (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du266 v0 v1
  = case coe v1 of
      C224 -> coe (\ v3 -> C224) erased
      C228 v3
        -> case coe v0 of
             C20 v4
               -> coe
                    (\ v5 v6 -> C228 v6) erased
                    (du266 (coe MAlonzo.Code.Codata.Thunk.d24 v4 erased) (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      C228 v4
        -> case coe v0 of
             C20 v5
               -> coe
                    (\ v6 v7 -> C228 v7) erased
                    (du282
                       (coe MAlonzo.Code.Codata.Thunk.d24 v5 erased) (coe v4) (coe v2))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
