...
d10 a0 a1 a2 = ()
data T10
  = C3 (MAlonzo.Code.Agda.Builtin.Size.T10 AgdaAny -> AgdaAny)
...
du94 ::
  (MAlonzo.Code.Agda.Builtin.Size.T8 -> AgdaAny -> AgdaAny) ->
  T10 -> T10
du94 v0 v1 = coe (C3 (coe (\ v2 -> coe v0 v2 (coe d24 v1 erased))))
...
du112 :: T10 -> T10
du112 v0
  = coe (C3 (coe (\ v1 -> C3 (coe (\ v2 -> coe d24 v0 erased)))))
...
du128 :: T10 -> T10 -> T10
du128 v0 v1
  = coe (C3 (coe (\ v2 -> coe d24 v0 erased (coe d24 v1 erased))))
...
du142 ::
  (MAlonzo.Code.Agda.Builtin.Size.T8 -> T10 -> AgdaAny) ->
  MAlonzo.Code.Agda.Builtin.Size.T8 -> AgdaAny
du142 v0 v1 = coe v0 v1 (C3 (coe (\ v2 -> du142 (coe v0) erased)))
