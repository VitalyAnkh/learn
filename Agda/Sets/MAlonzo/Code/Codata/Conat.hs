...
du16
  = coe
      (C12 (coe (MAlonzo.Code.Codata.Thunk.C3 (coe (\ v0 -> du16)))))
...
d20 v0
  = case coe v0 of
      ...
      _ -> let v1 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (C12
                (coe (MAlonzo.Code.Codata.Thunk.C3 (coe (\ v2 -> d20 (coe v1))))))
             ...
             (C12
                (coe
                   (MAlonzo.Code.Codata.Thunk.C3
                      (coe
                         (\ v3 ->
                            du56 (coe MAlonzo.Code.Codata.Thunk.d24 v2 erased) (coe v1))))))
      _ -> MAlonzo.RTE.mazUnreachableError
             ...
             (C12
                (coe
                   (MAlonzo.Code.Codata.Thunk.C3
                      (coe
                         (\ v3 ->
                            du68 (coe MAlonzo.Code.Codata.Thunk.d24 v2 erased) (coe v1))))))
      _ -> MAlonzo.RTE.mazUnreachableError
             ...
             C12 v4
               -> coe
                    (addInt
                       (coe (1 :: Integer))
                       (coe
                          (d130 (coe MAlonzo.Code.Codata.Thunk.d24 v4 erased) (coe v3))))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
d158 v0
  = case coe v0 of
      0 -> coe (\ v1 -> C142) erased
      _ -> let v1 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (\ v2 v3 v4 -> C148 v4) erased erased (d158 (coe v1))
