...
du52 v0 v1
  = case coe v0 of
      0 -> coe v1 MAlonzo.Code.Data.Vec.Base.C28
                  ...
                  (coe
                     (\ v4 ->
                        coe
                          v1
                          (coe
                             (\ v5 v6 v7 -> MAlonzo.Code.Data.Vec.Base.C36 v6 v7) erased v3
                             v4))))
...
du194 v0
  = coe
      (MAlonzo.Code.Function.Equivalence.du56
         (coe (du214 (coe v0))) (coe (du232 (coe v0))))
...
du248 v0
  = coe
      (MAlonzo.Code.Function.Equivalence.du56
         (coe (du268 (coe v0))) (coe (du284 (coe v0))))
             ...
             MAlonzo.Code.Agda.Builtin.Sigma.C32 v3 v4
               -> coe
                    (MAlonzo.Code.Data.Product.du150
                       ...
                       (coe (\ v5 v6 -> v6)) (coe (du268 (coe v2) (coe v4))))
             _ -> MAlonzo.RTE.mazUnreachableError
