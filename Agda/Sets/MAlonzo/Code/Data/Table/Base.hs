...
du34 :: T20 -> AgdaAny
du34 v0
  = coe d28 v0 (coe (\ v1 -> MAlonzo.Code.Data.Fin.Base.C10) erased)
      ...
      (C30
         (coe
            (\ v1 ->
               coe
                 d28 v0
                 (coe (\ v2 v3 -> MAlonzo.Code.Data.Fin.Base.C16 v3) erased v1))))
...
du52 v0 v1
  = coe
      (C30
         (coe
            (\ v2 ->
               coe d28 v1 (MAlonzo.Code.Data.Fin.Base.du358 (coe v0) (coe v2)))))
...
du78 :: T20 -> T20 -> T20
du78 v0 v1
  = coe (C30 (coe (\ v2 -> coe d28 v0 v2 (coe d28 v1 v2))))
...
du88 v0 v1 v2 v3
  = case coe v0 of
      ...
      _ -> let v4 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             v1
             (coe d28 v3 (coe (\ v5 -> MAlonzo.Code.Data.Fin.Base.C10) erased))
             (du88
                   ...
                   (C30
                      (coe
                         (\ v5 ->
                            coe
                              d28 v3
                              (coe (\ v6 v7 -> MAlonzo.Code.Data.Fin.Base.C16 v7) erased v5))))))
...
du132 v0 v1
  = coe
      (MAlonzo.Code.Data.List.Base.du362 (coe v0) (coe (d28 (coe v1))))
name136 = "Data.Table.Base.fromList"
d136 :: MAlonzo.Code.Agda.Primitive.T4 -> () -> [AgdaAny] -> T20
d136 v0 v1 v2 = du136 v2
du136 :: [AgdaAny] -> T20
du136 v0
  = coe (C30 (coe (MAlonzo.Code.Data.List.Base.du372 (coe v0))))
...
du140 v0
  = coe (C30 (coe (MAlonzo.Code.Data.Vec.Base.du88 (coe v0))))
...
du144 v0 v1
  = coe
      (MAlonzo.Code.Data.Vec.Base.du494 (coe v0) (coe (d28 (coe v1))))
