      ...
      C20 v2 v3 v4
        -> coe
             (C20
                ...
                (coe
                   (\ v5 v6 v7 -> MAlonzo.Code.Data.Vec.Base.C36 v6 v7) erased v0 v4))
...
du70 v0
  = case coe v0 of
      C20 v1 v2 v3
        -> case coe v3 of
             MAlonzo.Code.Data.Vec.Base.C28 -> coe (\ v4 -> C54) erased
             MAlonzo.Code.Data.Vec.Base.C36 v5 v6
               -> let v7 = subInt (coe v2) (coe (1 :: Integer)) in
                  coe
                    (\ v8 v9 v10 -> C62 v9 v10) erased v5
                    (C20 (coe v1) (coe v7) (coe v6))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du82 v0
  = case coe v0 of
      C20 v1 v2 v3
        -> coe
             (C20
                (coe (addInt (coe (1 :: Integer)) (coe v1))) (coe v2) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
...
du112 v0
  = coe
      (C20
         ...
         (coe (MAlonzo.Code.Data.Vec.Base.du646 (coe v0))))
...
du126 v0
  = case coe v0 of
      C20 v1 v2 v3 -> coe (MAlonzo.Code.Data.Vec.Base.du638 (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
