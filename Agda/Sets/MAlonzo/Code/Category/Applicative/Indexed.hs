...
d228 ::
  ...
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T180 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T8
...
d292 ::
  ...
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T242 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T8
...
d428 ::
  ...
  T24 ->
  T24 ->
  T314 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T8
