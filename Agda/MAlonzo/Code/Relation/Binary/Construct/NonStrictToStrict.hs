      ...
      MAlonzo.Code.Data.Sum.Base.C42 v7
        -> coe
             (MAlonzo.Code.Agda.Builtin.Sigma.C32
                (coe v7) (coe (\ v8 -> coe v5 (coe v1 v3 v4 (coe v0 v4 v3 v8)))))
      ...
      MAlonzo.Code.Agda.Builtin.Sigma.C32 v2 v3
        -> coe
             (MAlonzo.Code.Agda.Builtin.Sigma.C32
                (coe
                   (du306
                      (coe (MAlonzo.Code.Relation.Binary.Structures.d36 (coe v0)))
        ...
        -> if coe v5
             then case coe v6 of
                    MAlonzo.Code.Relation.Nullary.C22 v7
                      -> coe
                           (\ v8 v9 v10 -> MAlonzo.Code.Relation.Binary.Definitions.C158 v9)
                           erased v7 erased
                    _ -> MAlonzo.RTE.mazUnreachableError
             else coe
                    (seq
                       ...
                       (let v7 = coe v1 v2 v3 in
                        case coe v7 of
                          MAlonzo.Code.Data.Sum.Base.C38 v8
                            -> coe
                                 (\ v9 v10 v11 -> MAlonzo.Code.Relation.Binary.Definitions.C150 v9)
                                 (MAlonzo.Code.Agda.Builtin.Sigma.C32 (coe v8) erased) erased erased
                          MAlonzo.Code.Data.Sum.Base.C42 v8
                            -> coe
                                 (\ v9 v10 v11 -> MAlonzo.Code.Relation.Binary.Definitions.C166 v11)
                                 erased erased (MAlonzo.Code.Agda.Builtin.Sigma.C32 (coe v8) erased)
                          _ -> MAlonzo.RTE.mazUnreachableError))
      _ -> MAlonzo.RTE.mazUnreachableError
...
du438 v0
  = coe
      (\ v1 v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Structures.C2525 v1 v3 v4)
      (MAlonzo.Code.Relation.Binary.Structures.d80
...
d478 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T452
...
name580 = "Relation.Binary.Construct.NonStrictToStrict.irrefl"
d580 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T14 -> MAlonzo.Code.Data.Empty.T4
d580 = erased
name582 = "Relation.Binary.Construct.NonStrictToStrict.trans"
d582 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
d584 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T14 -> MAlonzo.Code.Data.Empty.T4
d584 = erased
name586 = "Relation.Binary.Construct.NonStrictToStrict.decidable"
d586 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
du588 ::
  ...
  (AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Sum.Base.T30) ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Binary.Definitions.T136
du588 = coe (\ v0 v1 v2 v3 v4 v5 -> du346 v1 v3 v4 v5)
name590
