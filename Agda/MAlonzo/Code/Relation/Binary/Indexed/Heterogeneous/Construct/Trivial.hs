...
du32 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.Structures.C33
         (coe
...
du60 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.Structures.C637
         (coe
            (du32
...
du100 v0
  = coe
      ...
      erased erased
      (du32 (coe (MAlonzo.Code.Relation.Binary.Bundles.d60 (coe v0))))
name136
...
du136 v0
  = coe
      (\ v1 v2 v3 v4 ->
         MAlonzo.Code.Relation.Binary.Indexed.Heterogeneous.Bundles.C219 v4)
      erased erased erased
      (du60 (coe (MAlonzo.Code.Relation.Binary.Bundles.d150 (coe v0))))
