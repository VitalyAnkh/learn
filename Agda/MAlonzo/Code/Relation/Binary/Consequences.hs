...
du596 v0 v1
  = coe
      (MAlonzo.Code.Agda.Builtin.Sigma.C32
         (coe (\ v2 v3 v4 v5 v6 -> du444 (coe v0) (coe v1) v2 v4))
         (coe (\ v2 v3 v4 v5 v6 -> du528 (coe v0) (coe v1) v2 v4)))
...
d704 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Relation.Binary.Definitions.T310 ->
  MAlonzo.Code.Relation.Binary.Definitions.T310
...
du704 v0 v1
  = coe
      (MAlonzo.Code.Relation.Binary.Definitions.C330
         (coe (MAlonzo.Code.Relation.Binary.Definitions.d324 (coe v1)))
         (coe (MAlonzo.Code.Relation.Binary.Definitions.d326 (coe v1)))
         (coe
            v0 (MAlonzo.Code.Relation.Binary.Definitions.d324 (coe v1))
            (MAlonzo.Code.Relation.Binary.Definitions.d326 (coe v1))
            (MAlonzo.Code.Relation.Binary.Definitions.d328 (coe v1))))
...
du726 ::
  ...
  AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Sum.Base.T30
du726 v0 v1 v2
  = coe (MAlonzo.Code.Data.Sum.Base.du76 (coe v0 v2 v1))
...
du746 v0 v1 v2 v3
  = coe
      (\ v4 ->
         MAlonzo.Code.Relation.Nullary.du60 (coe v0) (coe v1 v2 v3))
