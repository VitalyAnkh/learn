...
d16 a0 a1 a2 a3 = ()
data T16
  = C15 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du42 :: T26 -> T16
du42 v0 = coe (C15 (coe (d36 (coe v0))) (coe (d38 (coe v0))))
...
du60 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> AgdaAny
du60 v0 = coe (\ v1 v2 v3 -> du40 (coe (d50 (coe v0))) v1)
...
du92 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> AgdaAny
du92 v0 = coe (\ v1 v2 v3 -> du40 (coe (d80 (coe v0))) v1)
...
du112 v0
  = coe
      (MAlonzo.Code.Agda.Builtin.Sigma.C32
         (coe (du106 (coe v0))) (coe (du100 (coe v0))))
name118 = "Relation.Binary.Structures.IsPartialOrder"
d118 a0 a1 a2 a3 a4 a5 = ()
data T118
  = C1589 T70 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du148 :: T118 -> T16
du148 v0
  = let v1 = d126 (coe v0) in coe (du42 (coe (d80 (coe v1))))
...
du152 v0
  = let v1 = d126 (coe v0) in
    coe (\ v2 v3 v4 -> du40 (coe (d80 (coe v1))) v2)
...
du186 v0
  = let v1 = d172 (coe v0) in coe (du98 (coe (d126 (coe v1))))
name188
...
du192 v0
  = let v1 = d172 (coe v0) in coe (du112 (coe (d126 (coe v1))))
name194
...
du194 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du194 v0
  = let v1 = d172 (coe v0) in coe (du106 (coe (d126 (coe v1))))
name196
...
du196 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du196 v0
  = let v1 = d172 (coe v0) in coe (du100 (coe (d126 (coe v1))))
name200
...
du200 v0
  = coe
      (C589
         (coe (d80 (coe (d126 (coe (d172 (coe v0)))))))
         (coe (d174 (coe v0))))
...
du208 :: T162 -> T16
du208 v0
  = let v1 = du200 (coe v0) in coe (du42 (coe (d50 (coe v1))))
...
du212 ::
  ...
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> AgdaAny
du212 v0
  = let v1 = du200 (coe v0) in
    coe (\ v2 v3 v4 -> du40 (coe (d50 (coe v1))) v2)
...
du248 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> AgdaAny
du248 v0 = coe (\ v1 v2 v3 -> du40 (coe (d234 (coe v0))) v1)
...
du306 :: T270 -> T16
du306 v0
  = let v1 = d280 (coe v0) in coe (du42 (coe (d234 (coe v1))))
name308
...
du310 v0
  = let v1 = d280 (coe v0) in
    coe (\ v2 v3 v4 -> du40 (coe (d234 (coe v1))) v2)
name312
...
du318 v0
  = coe
      (C589 (coe (d234 (coe (d280 (coe v0))))) (coe (d282 (coe v0))))
name322
...
du326 :: T270 -> T16
du326 v0
  = let v1 = du318 (coe v0) in coe (du42 (coe (d50 (coe v1))))
name328
...
data T340
  = C3913 T118 (AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Sum.Base.T30)
...
du360 v0
  = let v1 = d348 (coe v0) in coe (du98 (coe (d126 (coe v1))))
...
du366 v0
  = let v1 = d348 (coe v0) in coe (du112 (coe (d126 (coe v1))))
...
du368 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du368 v0
  = let v1 = d348 (coe v0) in coe (du106 (coe (d126 (coe v1))))
...
du370 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du370 v0
  = let v1 = d348 (coe v0) in coe (du100 (coe (d126 (coe v1))))
name374
...
du378 v0
  = let v1 = d348 (coe v0) in
    ...
    coe (\ v3 v4 v5 -> du40 (coe (d80 (coe v2))) v3)
...
du430 v0
  = coe
      (C589
         (coe (d80 (coe (d126 (coe (d348 (coe (d398 (coe v0)))))))))
         (coe (d400 (coe v0))))
name434 = "Relation.Binary.Structures.IsDecTotalOrder.Eq._._≟_"
d434 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du438 :: T388 -> T16
du438 v0
  = let v1 = du430 (coe v0) in coe (du42 (coe (d50 (coe v1))))
name440 = "Relation.Binary.Structures.IsDecTotalOrder.Eq._.refl"
d440 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du440 :: T388 -> AgdaAny -> AgdaAny
du440 v0
  = coe
      (d34 (coe (d80 (coe (d126 (coe (d348 (coe (d398 (coe v0))))))))))
name442
...
du442 v0
  = let v1 = du430 (coe v0) in
    coe (\ v2 v3 v4 -> du40 (coe (d50 (coe v1))) v2)
name444 = "Relation.Binary.Structures.IsDecTotalOrder.Eq._.sym"
d444 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du444 :: T388 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du444 v0
  = coe
      (d36 (coe (d80 (coe (d126 (coe (d348 (coe (d398 (coe v0))))))))))
name446 = "Relation.Binary.Structures.IsDecTotalOrder.Eq._.trans"
d446 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du446 v0
  = coe
      (d38 (coe (d80 (coe (d126 (coe (d348 (coe (d398 (coe v0))))))))))
name452 = "Relation.Binary.Structures.IsStrictTotalOrder"
d452 a0 a1 a2 a3 a4 a5 = ()
data T452
  = C4945 T26
          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
          (AgdaAny ->
...
d462 v0
  = case coe v0 of
      C4945 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
name464 = "Relation.Binary.Structures.IsStrictTotalOrder.trans"
d464 ::
  T452 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d464 v0
  = case coe v0 of
      C4945 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
name466 = "Relation.Binary.Structures.IsStrictTotalOrder.compare"
d466 ::
  T452 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Binary.Definitions.T136
d466 v0
  = case coe v0 of
      C4945 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
name468 = "Relation.Binary.Structures.IsStrictTotalOrder._≟_"
d468 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) ->
  T452 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T32
d468 v0 v1 v2 v3 v4 v5 v6 = du468 v6
du468 ::
  T452 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T32
du468 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Consequences.du372
         (coe (d466 (coe v0))))
...
du470 v0
  = coe
      (MAlonzo.Code.Relation.Binary.Consequences.du408
         (coe (d466 (coe v0))))
name472
...
d472 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> T44
d472 v0 v1 v2 v3 v4 v5 v6 = du472 v6
du472 :: T452 -> T44
du472 v0 = coe (C589 (coe (d462 (coe v0))) (coe (du468 (coe v0))))
name476 = "Relation.Binary.Structures.IsStrictTotalOrder.Eq._≟_"
d476 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  T452 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T32
d476 v0 v1 v2 v3 v4 v5 v6 = du476 v6
du476 ::
  T452 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T32
du476 v0 = coe (du468 (coe v0))
name478
...
d478 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> T26
d478 v0 v1 v2 v3 v4 v5 v6 = du478 v6
du478 :: T452 -> T26
du478 v0 = coe (d462 (coe v0))
name480
...
d480 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> T16
d480 v0 v1 v2 v3 v4 v5 v6 = du480 v6
du480 :: T452 -> T16
du480 v0
  = let v1 = du472 (coe v0) in coe (du42 (coe (d50 (coe v1))))
name482 = "Relation.Binary.Structures.IsStrictTotalOrder.Eq.refl"
d482 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> AgdaAny -> AgdaAny
d482 v0 v1 v2 v3 v4 v5 v6 = du482 v6
du482 :: T452 -> AgdaAny -> AgdaAny
du482 v0 = coe (d34 (coe (d462 (coe v0))))
name484
...
du484 ::
  ...
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> AgdaAny
du484 v0
  = let v1 = du472 (coe v0) in
    coe (\ v2 v3 v4 -> du40 (coe (d50 (coe v1))) v2)
name486 = "Relation.Binary.Structures.IsStrictTotalOrder.Eq.sym"
d486 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du486 :: T452 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du486 v0 = coe (d36 (coe (d462 (coe v0))))
name488 = "Relation.Binary.Structures.IsStrictTotalOrder.Eq.trans"
d488 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
...
du488 ::
  T452 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du488 v0 = coe (d38 (coe (d462 (coe v0))))
name490
...
d490 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> T222
d490 v0 v1 v2 v3 v4 v5 v6 = du490 v4 v6
du490 :: MAlonzo.Code.Agda.Primitive.T4 -> T452 -> T222
du490 v0 v1
  = coe
      (\ v2 v3 v4 v5 -> C2525 v2 v4 v5) (d462 (coe v1)) erased
      (d464 (coe v1))
      (MAlonzo.Code.Relation.Binary.Consequences.du596
         (coe v0) (coe (d466 (coe v1))))
name492
...
d492 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  (AgdaAny -> AgdaAny -> ()) -> T452 -> T270
d492 v0 v1 v2 v3 v4 v5 v6 = du492 v4 v6
du492 :: MAlonzo.Code.Agda.Primitive.T4 -> T452 -> T270
du492 v0 v1
  = coe
      (C3289
         (coe (du490 (coe v0) (coe v1))) (coe (du468 (coe v1)))
         (coe (du470 (coe v1))))
name496
...
d496 v0 v1 v2 v3 v4 v5 v6 = du496 v4 v6
du496 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  T452 -> MAlonzo.Code.Agda.Builtin.Sigma.T14
du496 v0 v1
...
name502 = "Relation.Binary.Structures.IsStrictTotalOrder._.asym"
d502 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  AgdaAny -> AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Empty.T4
d502 = erased
name504 = "Relation.Binary.Structures.IsStrictTotalOrder._.irrefl"
d504 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
