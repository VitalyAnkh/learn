...
name48 = "Relation.Binary.Reasoning.Base.Partial._∼⟨_⟩_"
d48 ::
...
du48 v0 v1 v2 v3 v4 v5
  = case coe v5 of
      C32 v6 -> coe (C32 (coe v0 v1 v2 v3 v4 v6))
      _ -> MAlonzo.RTE.mazUnreachableError
name60 = "Relation.Binary.Reasoning.Base.Partial._≡⟨_⟩_"
d60 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  AgdaAny ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12 -> T24 -> T24
d60 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 = du60 v9
du60 :: T24 -> T24
du60 v0 = coe v0
name70 = "Relation.Binary.Reasoning.Base.Partial._≡˘⟨_⟩_"
d70 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
