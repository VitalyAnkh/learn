...
du24 v0
  = coe (MAlonzo.Code.Data.Bool.Base.d22 (coe (du16 (coe v0))))
  ...
  = case coe v0 of
      MAlonzo.Code.Relation.Nullary.C46 v1 v2
        -> if coe v1
             ...
             else coe (MAlonzo.Code.Level.C20 erased)
      _ -> MAlonzo.RTE.mazUnreachableError
...
du78 v0
  = case coe v0 of
      MAlonzo.Code.Relation.Nullary.C46 v1 v2
        -> if coe v1
             then coe (MAlonzo.Code.Level.C20 erased)
              ...
              -> if coe v2
                   then coe
                          (MAlonzo.Code.Relation.Nullary.C22
                             (coe v0 (MAlonzo.Code.Relation.Nullary.Reflects.du20 (coe v3))))
                   else coe (\ v4 -> MAlonzo.Code.Relation.Nullary.C26) erased
            _ -> MAlonzo.RTE.mazUnreachableError))
