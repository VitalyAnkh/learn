...
d32 :: Bool -> T22
d32 v0 = if coe v0 then coe (C30 erased) else coe C26
...
d78 v0
  = case coe v0 of
      C26 -> coe (MAlonzo.Code.Level.C20 erased)
      C30 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du82 v0 = coe (du50 (coe (\ v1 -> C30 (coe v0 v1))) (coe C26))
  ...
  = case coe v1 of
      C26
        -> case coe v2 of
             C26 -> coe v2
             C30 v3
               -> coe (C30 (coe v0 (MAlonzo.Code.Data.These.Base.C50 (coe v3))))
             _ -> MAlonzo.RTE.mazUnreachableError
      C30 v3
        -> case coe v2 of
             C26
               -> coe (C30 (coe v0 (MAlonzo.Code.Data.These.Base.C48 (coe v3))))
             C30 v4
               -> coe
                    (C30 (coe v0 (MAlonzo.Code.Data.These.Base.C52 (coe v3) (coe v4))))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
