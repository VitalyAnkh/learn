...
d174 ::
  ...
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T14 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T10
...
d250 ::
  ...
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T202 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T10
...
d320 ::
  ...
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T272 -> AgdaAny -> AgdaAny -> MAlonzo.Code.Category.Functor.T10
